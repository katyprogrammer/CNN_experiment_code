...
from lasagne.layers import get_all_layers, get_output, InputLayer, Layer
from lasagne import regularization
from lasagne.objectives import aggregate, categorical_crossentropy, squared_error
from lasagne.updates import nesterov_momentum
from lasagne.utils import floatX, unique
import numpy as np
...
class NeuralNet(BaseEstimator):
    ...
    def __init__(
        ...
        custom_regularizor=None,
        batch_iterator_train=BatchIterator(batch_size=128*2),
        batch_iterator_test=BatchIterator(batch_size=128*2),
        regression=False,
        max_epochs=100,
        ...
        **kwargs
        ...
        self.custom_regularizor = custom_regularizor
        if self.verbose:
    ...
    def _create_iter_funcs(self, layers, objective, update, output_type):
        ...
        loss_train = objective(
            layers, target=y_batch, custom_regularizor=self.custom_regularizor, **objective_kw)
        loss_eval = objective(
